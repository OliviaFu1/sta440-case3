...
x_modified<-x_modified|>mutate(region_category= case_when(
...
#GLS
library(nlme)
gls.out<-nlme::gls(obsTTmodified~DISPATCH.PRIORITY.NAME,corr=corCompSymm(value=0.5,form=~1|region_category),data=x_modified, na.action=na.omit)
summary(gls.out)

...
```{r}
ggplot(changed_df,aes(x=fitted,y=ETT_sec,color=Scenario))+geom_point()+geom_smooth(method="lm",se=FALSE)

ggplot(changed_df,aes(x=fitted,y=ETT_sec,color=region))+geom_point()+geom_smooth(method="lm",se=FALSE)
...
labs(x="Scenario",y="EMM")+theme_minimal()
